...
1. `using namespace std;` использовать <details><summary>нельзя.</summary>
...
4. Не используйте ввод-вывод в стиле С через функции <details><summary>scanf, printf:</summary>
...
![Styleguide Cat](images/styleguide_cat.jpg)